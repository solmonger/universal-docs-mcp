...
- [ ] Slice 01 — benchmark harness and executable oracles
- [ ] Slice 02 — version-sensitive fixture corpus
- [ ] Slice 03 — manual-context upper-bound run and source-profile decision
