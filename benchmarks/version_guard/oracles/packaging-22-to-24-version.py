"""Blind behavioral oracle for packaging-22-to-24-version; never copied into the agent workspace."""
import json
import runpy
import sys
import types

CASE_ID = 'packaging-22-to-24-version'
EXPECTED_API = 'version_new'
